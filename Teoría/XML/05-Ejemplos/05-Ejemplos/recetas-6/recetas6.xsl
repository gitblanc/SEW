...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:variable name="chiken" select="'pollo'"/>
	
	<xsl:template match="cooking-recipes">
		<xsl:text disable-output-escaping='yes'>&lt;!DOCTYPE html></xsl:text>
		<html lang="es">
			<head>
				<meta name="description" content="Ejercicio resuelto 6"/>
			...
			<body>
				...
				<main>
					<xsl:for-each select="cooking-recipe">
						...
						<xsl:if test="contains($ingredients-lower-case, $chiken)">
