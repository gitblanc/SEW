...
def inicializarHTML():
    ...
    html.write("\t<meta name =\"description\" content =\"Pagina principal\" />\n")
    html.write("\t<meta name =\"keywords\" content =\"Personas\" />\n")
    html.write("\t<!--Definicion de la ventana grafica-->\n")
...
def escribirLinea(linea, cont):
    if "nombre" in linea:
        ...
        linea = re.sub("</comentarios>", "", linea)
        linea.rstrip()
        escribirLineaAHTML("\t\t\t\t<p>Comentarios: " + linea + "</p>\t\t\n")
