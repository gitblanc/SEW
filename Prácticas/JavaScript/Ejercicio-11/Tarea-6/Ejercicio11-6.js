...
class MapaDinamicoGoogle {
    ...
    mostrarMapa(){
        $('h2').after("<script src=\"https://maps.googleapis.com/maps/api/js?key=AIzaSyBgJf4BuRtfhXGqUJes5RfuMPx54xr3hFw&callback=mapaExtra.initMap&v=weekly\"defer></script>")
    }
    initMap(){
...
var mapaExtra = new MapaDinamicoGoogle();